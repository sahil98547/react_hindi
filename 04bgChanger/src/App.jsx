    ...
    <div className="w-full h-screen duration-200"
      ...
      <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
          ...
          <button onClick={() => { setColor('olive') }} className="outline-none px-4 rounded-full text-white shadow-lg"
            style={{ backgroundColor: 'olive' }}>
            Olive
          </button>
          <button onClick={() => { setColor('gray') }} className="outline-none px-4 rounded-full text-white shadow-lg"
            style={{ backgroundColor: 'gray' }}>
            Gray
          </button>
          <button onClick={() => { setColor('yellow') }} className="outline-none px-4 rounded-full text-black shadow-lg"
            style={{ backgroundColor: 'yellow' }}>
            Yellow
          </button>
          <button onClick={() => { setColor('pink') }} className="outline-none px-4 rounded-full text-black shadow-lg"
          ...
          <button onClick={() => { setColor('#263238') }} className="outline-none px-4 rounded-full text-white shadow-lg"
